  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-100">Lista de Museos</h2>
      ...
      {hasMore && (
        <div className="flex justify-center">
          <button
            ...
            className="px-6 py-2 bg-purple-600/20 text-purple-400 rounded-lg text-sm hover:bg-purple-600/30 transition-colors border border-purple-500/20"
          >
